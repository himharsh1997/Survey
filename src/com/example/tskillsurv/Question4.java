...
public class Question4  extends Activity implements OnItemSelectedListener{
	 Spinner sp;
	   String[] mg=new String[]{
		   		 "-Select-","0","1","2","3","4","5"}; 
	   SQLiteDatabase sqldb4;
	  	final String database_name = "quest44.db";
	      final String table_name = "My_Quesmy44";
	...
	protected void onCreate(Bundle savedInstanceState) {
	  ...
	  sp = (Spinner)findViewById(R.id.spinn4);
	    ArrayAdapter<String> Adp1=new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item,mg);
	    Adp1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
	    try{
		     sqldb4 = openOrCreateDatabase(database_name, SQLiteDatabase.CREATE_IF_NECESSARY, null);
			   sqldb4.execSQL("CREATE TABLE IF NOT EXISTS "+table_name+"(Name TEXT PRIMARY KEY NOT NULL, Grade TEXT)");
	...
	public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2,
		...
		String stt = (String)sp.getItemAtPosition(sp.getSelectedItemPosition());	
		 if(stt=="-Select-"){Toast.makeText(getApplicationContext(), "Data save", Toast.LENGTH_LONG);}
		  ...
		  sqldb4.execSQL("INSERT INTO "+ table_name+ "(Name,Grade) VALUES ('"+ss+"','"+stt+"')");
