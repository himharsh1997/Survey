...
public class Question3  extends Activity implements OnItemSelectedListener{

	 Spinner sp;
	   String[] mg=new String[]{
		   		 "-Select-","0","1","2","3","4","5"}; 
	   SQLiteDatabase sqldb3;
	  	final String database_name = "quest33.db";
	      final String table_name = "My_Quesmy33";
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
	setContentView(R.layout.quest3);
	sp = (Spinner)findViewById(R.id.spinn3);
    ArrayAdapter<String> Adp1=new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item,mg);
    Adp1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    try{
	     sqldb3 = openOrCreateDatabase(database_name, SQLiteDatabase.CREATE_IF_NECESSARY, null);
		   sqldb3.execSQL("CREATE TABLE IF NOT EXISTS "+table_name+"(Name TEXT PRIMARY KEY NOT NULL, Grade TEXT)");
	...
	public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2,
		...
		String stt = (String)sp.getItemAtPosition(sp.getSelectedItemPosition());	
		 if(stt=="-Select-"){Toast.makeText(getApplicationContext(), "Data save", Toast.LENGTH_LONG);}
		  ...
		  sqldb3.execSQL("INSERT INTO "+ table_name+ "(Name,Grade) VALUES ('"+ss+"','"+stt+"')");
